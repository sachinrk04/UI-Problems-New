...
import ReactVirtualizedScratch from "@/components/ReactVirtualizedComponents/ReactVirtualizedScratch";

const ReactVirtualizedPage = () => {
  return (
    <div className="flex flex-col p-4 overflow-auto gap-y-4">
      <div className="w-full px-4 py-2 overflow-auto rounded-md shadow-[0_2px_10px_rgba(0,0,0,0.10)]">
        <PageHeader title="React Virtualized" />
      </div>
...
export default ReactVirtualizedPage;
