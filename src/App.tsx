...
// ─── Lazy loaded ──────────────────────────────────────────────────────────────
// UI Problems
const AutocompletePage        = lazy(() => import("./pages/UIProblems/AutocompletePage"));
const FolderFileExplorerOne   = lazy(() => import("./pages/UIProblems/FolderFileExplorerOne"));
const FolderFileExplorerTwo   = lazy(() => import("./pages/UIProblems/FolderFileExplorerTwo"));
...
const TaskManagmentII         = lazy(() => import("./pages/UIProblems/TaskManagmentII"));
const TaskManagmentIII        = lazy(() => import("./pages/UIProblems/TaskManagmentIII"));
const PaginationPage          = lazy(() => import("./pages/UIProblems/PaginationPage"));
const InfiniteScrollPage      = lazy(() => import("./pages/UIProblems/InfiniteScrollPage"));
...
const DiceRollerThree         = lazy(() => import("./pages/UIProblems/DiceRollerThree"));
...
const BirthYearHistogramPage  = lazy(() => import("./pages/UIProblems/BirthYearHistogramPage"));
const NestedCheckboxesPage    = lazy(() => import("./pages/UIProblems/NestedCheckboxesPage"));
const TowerOfHanoiPage        = lazy(() => import("./pages/UIProblems/TowerOfHanoiPage"));
const TowerOfHanoiDnDII       = lazy(() => import("./pages/UIProblems/TowerOfHanoiDnDII"));
const TransferListPage        = lazy(() => import("./pages/UIProblems/TransferListPage"));
const TransferListIIPage      = lazy(() => import("./pages/UIProblems/TransferListIIPage"));
const SelectableCellsPage     = lazy(() => import("./pages/UIProblems/SelectableCellsPage"));
const LiftingStateUpPage      = lazy(() => import("./pages/UIProblems/LiftingStateUpPage"));
const GenerateTablePage       = lazy(() => import("./pages/UIProblems/GenerateTablePage"));

// React Hooks
const UseCounterPage          = lazy(() => import("./pages/ReactHooks/UseCounterPage"));
const UseCounterPageII        = lazy(() => import("./pages/ReactHooks/UseCounterPageII"));
const UseDebouncePage         = lazy(() => import("./pages/ReactHooks/UseDebouncePage"));
const UseLocalStoragePage     = lazy(() => import("./pages/ReactHooks/UseLocalStoragePage"));
const UseFetchPage            = lazy(() => import("./pages/ReactHooks/UseFetchPage"));
const UseGeolocationPage      = lazy(() => import("./pages/ReactHooks/UseGeolocationPage"));
const UseWindowSizePage       = lazy(() => import("./pages/ReactHooks/UseWindowSizePage"));
const UseStatePage            = lazy(() => import("./pages/ReactHooks/UseStatePage"));

// Algorithms
const CocktailShakerSortPage  = lazy(() => import("./pages/AlgorithmPage/CocktailShakerSortPage"));

// Git
const BasicGitCommands        = lazy(() => import("./pages/GitPage/BasicGitCommands"));
const BranchingCommands       = lazy(() => import("./pages/GitPage/BranchingCommands"));
const RemoteCommands          = lazy(() => import("./pages/GitPage/RemoteCommands"));
const StagingAndCommitting    = lazy(() => import("./pages/GitPage/StagingAndCommitting"));
        ...
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="ui-problems" element={<UIProblems />}>
            {uiRoutes.map(({ path, element }) => (
              <Route key={path} path={path} element={<Lazy element={element} />} />
            ))}
          </Route>
